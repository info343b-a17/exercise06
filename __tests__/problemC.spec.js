//problem config
const JS_FILE_PATH_ROOT = 'problemC/js/';
...
describe('Tweet display app', () => {
  ...
  describe('Model.js module', () => {
    let model;
    beforeAll(() => {
      model = require('../problemC/js/Model');
    })
  ...
  describe('Controller.js module', () => {
    let controller;
    beforeAll(() => {
      controller = require('../problemC/js/Controller');
    })
  ...
  describe('index.js entry script', () => {
    test('runs the program', () => {
      ...
      require('../problemC/js/index.js'); //run it!
